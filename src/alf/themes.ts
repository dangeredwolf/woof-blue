...
export function createThemes({
  ...
  const color = {
    ...
    primary_25: `hsl(${hues.primary}, 30%, 97%)`,
    primary_50: `hsl(${hues.primary}, 30%, 95%)`,
    primary_100: `hsl(${hues.primary}, 30%, 90%)`,
    primary_200: `hsl(${hues.primary}, 32%, 80%)`,
    primary_300: `hsl(${hues.primary}, 34%, 70%)`,
    primary_400: `hsl(${hues.primary}, 35%, 58%)`,
    primary_500: `hsl(${hues.primary}, 35%, 45%)`,
    primary_600: `hsl(${hues.primary}, 38%, 38%)`,
    primary_700: `hsl(${hues.primary}, 40%, 32%)`,
    primary_800: `hsl(${hues.primary}, 42%, 25%)`,
    primary_900: `hsl(${hues.primary}, 45%, 18%)`,
    primary_950: `hsl(${hues.primary}, 48%, 10%)`,
    primary_975: `hsl(${hues.primary}, 50%, 7%)`,
